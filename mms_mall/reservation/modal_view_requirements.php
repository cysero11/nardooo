  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <center id='content_img'>
          <div class="easyzoom easyzoom--overlay easyzoom--with-toggle">
              <a id="img_viewed2" href="">
                  <img id="img_viewed" src="" alt="" width="100%" height="380" />
              </a>
          </div>
        </center>
      <br />
      ...
      <div class="modal-footer" style="display: none;">
          <button class="toggle btn btn-md btn-info" data-active="true"><i style='color:white !important;' class='ace-icon fa fa-search-minus bigger-120'></i></button>
      </div> 
    </div>
  </div>
</div>
