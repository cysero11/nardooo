    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #438EB9;">
                ...
                <div class="modal-body" id="div_add_contact" style="display: block; height: 470px; overflow-y: scroll;">
                                ...
                                <div class="col-xs-12 col-md-8">
                                    <div class="input-group">
                                        ...
                                        <div class="spinbox-buttons input-group-btn">
                                          <button type="button" class="btn spinbox-up btn-sm btn-success" onclick="loadreferentialmodal('industry')" id="btncomp_industry">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <div class="well">
                                ...
                                <div class="row form-group">
                                    ...
                                    Current Address
                                    <label>
                                       <input name="form-field-checkbox" class="ace ace-checkbox-2 chk_advpyment chcksameadd" type="checkbox" value="" id="curr_add">
                                       <span style="font-size: 10px;" class="lbl"> (Same as permanent)</span>
                                    </label>
                                    </div>

                                    <script type="text/javascript">
                                        $(function(){
                                            $(".chcksameadd").change(function(){
                                                var txtcomp_perm_add = $("#txtcomp_perm_add").val();
                                                var karugtong = this.id;
                                                alert(karugtong);
                                                if($(this).is(":checked")){
                                                    $("#txtcomp_"+karugtong).val("  "+txtcomp_perm_add);
                                                    $("#txtcomp_"+karugtong+"_icon").addClass("fa-map-marker");
                                                }else{
                                ...
                                <div class="row form-group">
                                    ...
                                    Billing Address
                                    <label>
                                       <input name="form-field-checkbox" class="ace ace-checkbox-2 chk_advpyment chcksameadd" type="checkbox" value="" id="bill_add">
                                       <span style="font-size: 10px;" class="lbl"> (Same as permanent)</span>
                                    </label>
                                    </div>
                                    <div class="col-md-8 col-xs-12">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-xs-12 col-md-8">
                                                <div class="input-group">
                                                    ...
                                                    <div class="spinbox-buttons input-group-btn">
                                                      <button type="button" class="btn spinbox-up btn-sm btn-success" onclick="loadreferentialmodal('position')" id="btncontact_designation">
                                                        <i class="icon-only  ace-icon ace-icon fa fa-plus bigger-110"></i>
                                                      </button>
                                                    </div>
                                                </div>
                ...
                <div class="modal-footer">
                    <button id="modal_company_name" style="display: none;" class="btn btn-primary" onclick="savenewmall();">Save</button>
                </div>
        </div>
    </div>
</div>
...
$(function(){
    ...
    $("#btncomp_industry").keydown(function(e){
        var x = e.keyCode;
        if(x == 9)
        { loadaddressmodal("txtcomp_busadd") }
    });

    $("#txtcomp_lname").keydown(function(e){
        var x = e.keyCode;
        if(x == 9)
        { loadaddressmodal("txtcomp_perm_add") }
    });

    $("#btncontact_designation").keydown(function(e){
        var x = e.keyCode;
        if(x == 9)
        { loadaddressmodal("txtcontact_address") }
    });
});
    ...
    $('.email-address').each(function(){
        ...
        $(this).focusout(function() {
            ...
            if (validateEmail(sEmail)) {
                ...
                $("#error_"+this.id).text("Please enter valid email address");
    ...
    $('.website-input').each(function(){
        ...
        $(this).focusout(function() {
            ...
            if (validatWebsite(sEmail)) {
                ...
                // $(this).focus();
                $("#error_"+this.id).text("Please enter valid email address");
                // showmodal("alert", "Invalid Web Address.", "", null, "", null, "1");
                $(this).val("")
                e.preventDefault();
            }
        });
...
// save new mall func
    function savenewmall()
    {
        ...
        if(e == 0 && f != 0 && g != 0 && i != 0)
        {
            var name = encodeURIComponent($("#txtcomp_name").val());
        ...
        $.ajax({
          ...
          success:function(data){
            ...
            if(i == e)
            {
                $("#modal_new_company").modal("hide");
                $("#div_content_contact_person_list").html("");
                showmodal("alert", "Successfully Added.", "", null, "", null, "1");
                loadcompanylist();
            }
          }
        });
