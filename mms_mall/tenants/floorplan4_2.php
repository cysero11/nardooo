...
<script>
	...
	function loadpoints()
	{
		...
		$.ajax({
			...
			data: 'floorid=<?php echo $_POST["floorid"]; ?>&type=LCA&form=loadpoints3',
			beforeSend:function(){
			},
	...
	<div class="row">
    	<div class="col-sm-3">
            <div class="widget-box transparent">
            	<h1 style="color: #666; font-weight: 300; margin-top: 0px;">Floor Plan</h1>
                <h4 style="border: solid 1px #dddddd; padding: 10px; font-weight: 400; color: #333; background: #eeeeee;"><?php echo $_POST["floorname"]; ?></h4>
                <div class="widget-header">
                	<h4 class="widget-title lighter">Instructions</h4>
                </div>
        ...
        <div class="col-sm-9" style="text-align: center;">
            ...
            <div style="border: solid 1px #999; padding: 5px; margin-bottom: 10px;"><div id="showcanvas" style="height: 380px;"></div></div>
...
<script>
	...
	function loadunits()
	{
		...
		$.ajax({
			type: 'POST',
			url: 'tenants/mcp_mainclass.php',
			data: 'floorid=<?php echo $_POST["floorid"]; ?>&key=' + key + '&type=LCA&form=loadunits2',
			beforeSend:function(){
			},
			success: function(data) {
				$("#unitlist").html(data);
	...
	function addunit(unitid, unitname, status)
	{
		...
		$.ajax({
			type: 'POST',
			url: 'tenants/mcp_mainclass.php',
			data: 'floorid=<?php echo $_POST["floorid"]; ?>&unitid=' + unitid + '&unitname=' + unitname + '&status=' + status + '&coord=' + coord + '&type=LCA&form=saveplot3',
			beforeSend:function(){
			},
			success: function(data) {
				var arr = data.split("|");
