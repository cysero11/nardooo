<script type="text/javascript">
    ...
    function tblstorename() {
        ...
        $.ajax({
            ...
            '&form=tblstorename',
            beforeSend : function() {
             $('#tenant_history_list').addClass('myspinner2');
            },
            success: function(data) 
            {
                $('#tenant_history_list').removeClass('myspinner2');
    ...
    function tblstoreunit(tid) {
        ...
        $.ajax({
            ...
            '&form=tblstoreunit',
             beforeSend : function() {
              $('#tenant_history_div').addClass('myspinner');
             },
             success: function(data) 
             {
                 $('#tenant_history_div').removeClass('myspinner');
