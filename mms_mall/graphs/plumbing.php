...
";
	...
	// Push the data into the array
        	...
        	$columnChart = new FusionCharts("column2D", "con1" , "100%", 400, "plumbing", "json", $jsonEncodedData);
...
<div id="plumbing"><!-- Fusion Charts will render here--></div>