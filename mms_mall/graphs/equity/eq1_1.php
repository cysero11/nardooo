...
WHERE b.`SubheaderDesc` = 'Retained Earnings' and YEAR(a.`Batch_Date`) = ?
...
$cityPrepStmt = $dbhandle->prepare($cityQuery);
     	...
     	if ($cityResult) {
        	...
        	$arrData = array(
                "chart" => array(
        			...
        			"valueFontBold" => "1",
					"rotateValues" => "1",
                    "caption" => "Monthly Retained Earnings of  ".$countryName,
                    "showValues"=> "1",
                    "theme"=> "zune"
              	)
           	);
	...
	// Push the data into the array
           ...
           /*JSON Encode the data to retrieve the string containing the JSON representation of the data in the array. */
        	...
        	$columnChart = new FusionCharts("bar2d", "quart" , "100%", 450, "quarter", "json", $jsonEncodedData);
