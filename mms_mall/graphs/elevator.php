...
";
	...
	// Push the data into the array
        	...
        	$columnChart = new FusionCharts("column2D", "con3" , "100%", 400, "elevator", "json", $jsonEncodedData);
...
<div id="elevator"><!-- Fusion Charts will render here--></div>